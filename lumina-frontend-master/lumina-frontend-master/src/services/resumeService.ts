...
export const resumeService = {
    ...
    analyzeMatchScore: async (params: MatchScoreParams): Promise<MatchScoreResult> => {
        const response = await axiosInstance.post<MatchScoreResult>('/resumes/match-score', params);
        return response.data;
    },
